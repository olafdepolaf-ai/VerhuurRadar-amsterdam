...
const FAQSection: React.FC = () => (
    <div className="w-full max-w-2xl mx-auto mt-8 bg-white rounded-xl shadow-sm border text-left">
        ...
        <FAQItem q="Wat kost een vergunning en hoe lang is die geldig?" a={`Een vergunning kost eenmalig € 76,- (in 2026). De vergunning is geldig voor het lopende jaar tot 1 april van het volgende jaar.\n\nEr is een plan voor 2027 om de geldigheidsduur te verlengen naar 2 jaar in plaats van 15 maanden. Dit bespaart verhuurders kosten en administratie. De regels voor het maximumaantal nachten blijven gelijk.`} l="https://www.amsterdam.nl/nieuws/nieuwsoverzicht/nieuwe-woonregels/" lt="Lees meer over de nieuwe woonregels" />
