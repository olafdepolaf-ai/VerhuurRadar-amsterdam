        ...
        if (!isLoggedIn) {
            ...
            return (
                <div className="p-8 flex flex-col items-center text-center">
                    ...
                    {loginError && (
                        <div className="bg-red-50 border border-red-200 text-red-800 text-xs p-3 rounded-lg mb-4 text-left w-full">
                            <p className="font-bold mb-1">Configuratie Fout</p>
                            <p className="break-words">{loginError}</p>
                            {loginError.includes('unauthorized-domain') && (
                                <div className="mt-2 pt-2 border-t border-red-200">
                                    <p className="font-semibold">Hoe los je dit op:</p>
                                    <ol className="list-decimal list-inside mt-1 space-y-1">
                                        <li>Ga naar je Firebase Console.</li>
                                        <li>Kies Authentication → Settings.</li>
                                        <li>Selecteer de 'Authorized domains' tab.</li>
                                        <li>Klik op 'Add domain' en voeg het domein hierboven toe.</li>
                                    </ol>
                                </div>
                            )}
                        </div>
